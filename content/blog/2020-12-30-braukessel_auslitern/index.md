...
ist es recht sicher, dass die Skala im Braukessel korrekt ist. Wenn die eigene Paranoidität eher größer ist, 
kann dieser Prozess natürlich auch bis zur letzten Markierung wiederholt werden.

## Mein Kessel belügt mich, was kann ich tun?

Sollte Literskala nicht korrekt sein, muss eine eigene Literskala her. Das ist tatsächlich gar nicht so schwierig, 
...
Dieser ganze Prozess ist zwar nicht sonderlich gefährlich, und es wird auch nicht mit allzu allzu
...
Für die Markierung müssen passende Schablonen gesucht werden oder selbst gebastelt werden. Es gibt in Kreativmärkten
...
braucht. Es reicht auch bedeutend weniger. Lediglich das Wattestäbchen muss ausreichend feucht gehalten werden. 
...
Wattestäbchen gewickelt und dann mit Klebeband fixiert. Bei dem Kabel am Wattestäbchen sollte natürlich 
darauf geachtet werden, dass es lang genug ist.
...
dass die Markierung unschwarf wird. Ein leises Zischen und Blubbern sind gute Zeichen, dass alles funktioniert. 
...
sollten immer möglichst gleich sein. So kann auch geprüft werden wie exakt vorher gearbeitet wurde. Hat man
den Abstand zwischen den großen Markierungen ermittelt, wird dieser einfach durch die Zahl der kleinen
Markierungen geteilt. Wurde also bisher alle 5L markiert und sollen Litermarkierungen hinzugefügt werden,
wird der Abstand einfach durch 5 geteilt. Nun können die kleinere Markierungen z.B. mit einem Stift oder
wieder Klebeband markiert werden, damit später die Schablone für die kleineren Markierungen angelegt werden kann.
...
Das geht ganz einfach mit Zitronensäure. Bei den diversen bekannte Online-Händlern und -Portalen kann
einfach Zitronensäurepulver bestellen und daraus einenca 7%ige Lösung hergestellt werden. Bei einem 30L-Kessel werden
